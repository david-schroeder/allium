...
add wave -noupdate -divider {Coarse Decoder}
add wave -noupdate -radix riscv_instr /system_tb/board_i/DUT/core_i/bsd_dut/insn
...
add wave -noupdate -divider {Output IF}
