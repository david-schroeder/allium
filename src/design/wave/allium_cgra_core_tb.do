...
add wave -noupdate /allium_cgra_core_tb/DUT/fu_ldst_i/dmem
add wave -noupdate -expand /allium_cgra_core_tb/regfile
...
add wave -noupdate -expand /allium_cgra_core_tb/reg_out
...
add wave -noupdate /allium_cgra_core_tb/DUT/brh_a_data
add wave -noupdate /allium_cgra_core_tb/DUT/brh_a_valid
add wave -noupdate /allium_cgra_core_tb/DUT/brh_b_data
add wave -noupdate /allium_cgra_core_tb/DUT/brh_b_valid
...
add wave -noupdate /allium_cgra_core_tb/DUT/take_branch_o
add wave -noupdate -expand -group Valids /allium_cgra_core_tb/DUT/imm_valid
add wave -noupdate -expand -group Valids /allium_cgra_core_tb/DUT/alu_valid
add wave -noupdate -expand -group Valids /allium_cgra_core_tb/DUT/ldst_valid
add wave -noupdate -expand -group Valids /allium_cgra_core_tb/DUT/brh_valid
add wave -noupdate -expand -group Valids /allium_cgra_core_tb/DUT/global_valid_o
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {124417666 fs} 0}
...
update
WaveRestoreZoom {0 fs} {41864608 fs}
