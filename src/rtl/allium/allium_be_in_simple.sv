...
(
    ...
    logic [ 5:0] cfg_alu_srca_q;
    logic [ 5:0] cfg_alu_srcb_q;
    logic [ 5:0] cfg_ldst_srca_q;
    logic [ 5:0] cfg_ldst_srcb_q;
    logic [ 5:0] cfg_brh_srca_q;
    logic [ 5:0] cfg_brh_srcb_q;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (~rst_ni) begin
            ...
            if (cfg_update_i) begin
                ...
                cfg_alu_srca_q  <= cfg_alu_srca_i;
                cfg_alu_srcb_q  <= cfg_alu_srcb_i;
